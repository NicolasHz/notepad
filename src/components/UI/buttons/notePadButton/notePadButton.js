...
const notePadButton = () =>  (<div className={classes.NotePadButton}>
        <svg width="100%" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 58 58" style={{enableBackground:"new 0 0 58 58"}}>
            <g>
                ...
                <path style={{fill:"#FFFF76"}} d="M26,18.293H11c-0.553,0-1-0.448-1-1s0.447-1,1-1h15c0.553,0,1,0.448,1,1S26.553,18.293,26,18.293z"/>
                <path style={{fill:"#FFFF76"}} d="M45,26.293H11c-0.553,0-1-0.448-1-1s0.447-1,1-1h34c0.553,0,1,0.448,1,1S45.553,26.293,45,26.293z"/>
                <path style={{fill:"#FFFF76"}} d="M45,34.293H11c-0.553,0-1-0.448-1-1s0.447-1,1-1h34c0.553,0,1,0.448,1,1S45.553,34.293,45,34.293z"/>
            </g>
        </svg>
    </div>)
